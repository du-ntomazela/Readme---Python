noticias = {
    ...
    "Notícia 4": {
                 ...
                 "Conteúdo":
                     "Em conversa com o Total Motorsport, o vice-campeão da F-E disse que novos talentos não tem chance de chegar à Fórmula 1 porque não contam com o apoio de grandes patrocinadores e não desejam fazer o trabalho de piloto reserva. Evans decidiu trocar a F1 pela F-E aos 22 anos e continuará por lá, visto que as portas da mais alta categoria de automobilismo nunca chegaram a se abrir de fato para ele. Mitch aponta que a questão financeira é uma das causas para isso."
                 },
...
Pilotos = {
    "Nyck de Vries": {
        "Sobre" :
            "A promessa de Nyck ficou evidente desde cedo, com uma série de campeonatos nacionais, continentais e internacionais de kart – incluindo dois títulos mundiais de kart – antes de se formar em monopostos em 2012. Após duas temporadas ganhando experiência vital, de Vries foi coroado campeão na Fórmula Renault Eurocup em 2014, além de vencer a série ALPS afiliada. Ele então subiu para a Fórmula Renault 3.5, terminando em terceiro. Isso levou a uma mudança para a GP3, na qual o holandês terminou em sexto com duas vitórias. Sua ascensão contínua nas fórmulas juniores culminou na Fórmula 2 da FIA, na qual de Vries foi coroado campeão em 2019, antes de voltar sua atenção para o Campeonato Mundial de Fórmula E da ABB FIA. Estreando em Diriyah na Temporada 6, de Vries conquistou sua primeira vitória no mesmo circuito um ano depois. Outra vitória em Valência, mais dois pódios em Londres, foram suficientes para de Vries triunfar em uma batalha acirrada pelo campeonato sobre seu companheiro de equipe Edoardo Mortara por apenas sete pontos. Também o tornou o primeiro campeão mundial de Fórmula E sancionado pela FIA.Depois de mais uma temporada – e mais duas vitórias – de Vries partiu para a Fórmula 1, incluindo passagens pela Williams e Scuderia AlphaTauri. Agora, ele retorna à série totalmente elétrica da FIA, com a ambição de ganhar outro título mundial na Mahindra Racing."
    },
    "Edoardo Mortara" : {
        "Sobre" :
